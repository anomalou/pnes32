...
#define NES_VISIBLE_WIDTH SCREEN_HEIGHT
#define NES_VISIBLE_HEIGHT SCREEN_WIDTH
#define NES_WIDTH_OFFSET NES_SCREEN_WIDTH > NES_VISIBLE_WIDTH ? NES_SCREEN_WIDTH - NES_VISIBLE_WIDTH : 0
#define NES_HEIGHT_OFFSET NES_SCREEN_HEIGHT > NES_VISIBLE_HEIGHT ? NES_SCREEN_HEIGHT - NES_VISIBLE_HEIGHT : 0
